...
\title[mode = title]{Evaluation of different binder combinations for s/s treatment of TBT contaminated sediments}                      
%\tnotemark[1]
...
\begin{abstract}
On behalf of Cementa and Cowi, Swedish Geotechnical Institute (SGI) has evaluated the effect of the material technical and environmental technical properties of three different binder components. The project has a connection to the Arendal project. In the pilot trials before Arendal 2, two different recipes were evaluated, of which one recipe gave the best results. This recipe was cement and slag (GGBFS) in the proportions 50/50 and a total amount of admixture of 150 kg/m3 dredged material. Based on these results, an experiment was designed to study the effect of mixing in cement kiln dust (CKD) in order to utilise a residual product in this way while reducing the need for cement and slag. Methodology includes the geotechnical measurements, statistical processing of data and graphical visualisation of plots. The overall hypothesis is that it is possible to replace a part of cement or slag with cement kiln dust (CKD) without significantly deteriorating the results.
\end{abstract}
...
\begin{keywords}
cement \sep cement kiln dust (CKD) \sep slag \sep technical properties \sep binder components
\end{keywords}
...
\cite{ABDELGAWWAD2021102479}, \cite{SUTCU2016185}, \cite{WANG2020103489}, \cite{BAGHERI2020101809}, \cite{BERNAL2010898}, 
\cite{PEETHAMPARAN2008803}, \cite{CHAUNSALI2011197}, \cite{FAISAL2021105194}, \cite{YASERI2019592}, \cite{SHOAIB2000371}, 
\cite{Taha}, \cite{BAGHRICHE2020e00386}, \cite{RIBEIRO20093094}, \cite{SILVA2015108}, \cite{VIANI201456}, \cite{LI2017459},
\cite{ABDELGAWWAD20191218}, \cite{NOSJEAN202031}, \cite{SHAH2021}, \cite{ZAHRAN202094}, \cite{ADEYANJU2020e00388}, \cite{SUN2021123255},
\cite{SAMI2021106357}, \cite{SHEN2020103571}, \cite{ZHANG2021128926}, \cite{RIMAL2019e00223}, \cite{FIERTAK2013278}


\subsection{Background}

\subsection{Research aim}
On behalf of Cementa and Cowi, Swedish Geotechnical Institute (SGI) has evaluated the effect of the material technical and environmental technical properties of three different binder components. The project has a connection to the Arendal project. In the pilot trials before Arendal 2, two different recipes were evaluated, of which one recipe gave the best results. This recipe was cement and slag (GGBFS) in the proportions 50/50 and a total amount of admixture of $150 kg/m^3$ dredged material. Based on these results, an experiment was designed to study the effect of mixing in cement kiln dust (CKD) in order to utilise a residual product in this way while reducing the need for cement and slag. Methodology includes the geotechnical measurements, statistical processing of data and graphical visualisation of plots.
...
Here it can be noted (Fig. \ref{fig:3}) that the standard deviation for the higher water ratio is higher, i.e. it is more difficult to maintain the same homogeneity for the higher water ratio. The actual dry substances were 31.3 and 37.3\%, respectively (SS-EN 12880?), See Figure 4.
